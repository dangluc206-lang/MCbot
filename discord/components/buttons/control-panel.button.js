...
module.exports = {
    ...
    handlers: [
        ...
        [CustomId.PANEL_JOIN_12, { permission: Permission.ADMIN, cooldown: 5, minecraftRequired: true, async execute(ctx, interaction) { const result = await ctx.getService('skyblock').startJoin('discord-panel'); return interaction.update(panelPayload(ctx, `Vào SkyBlock: ${result}`)); } }],
